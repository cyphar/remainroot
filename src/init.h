...
#if !defined(REMAINROOT_INIT_H)
#define REMAINROOT_INIT_H

/*
 * Call this in order to initialise all of the remainroot state. No
 * memory is allocated as a result.
 */
void rr_init(void);

#endif /* !defined(REMAINROOT_INIT_H) */
